...
<p class="account"><label for="account">AccountNo</label></p>
<input id="account" name="account" placeholder="AccountNo" required tabindex="7" type="text">


<p class="street"><label for="street">Address</label></p>
<input id="street" name="street" placeholder="Street Address" required tabindex="8" type="text">
            ...
            <option value="Delhi">Delhi</option>
             <option value="Kolkatta">Kolakatta</option>
              <option value="Mumbai">Mumbai</option>
               <option value="Mumbai">Tirupathi</option>
                <option value="Mumbai">Hyderabad</option>
            </select><br><br>

<p class="pincode"><label for="pincode">Pin Code</label></p>
<input id="pincode" name="pincode" placeholder="Enter Pin Code" required tabindex="10" type="text">
<br>
<input class="buttom" name="submit" id="submit" tabindex="11" value="Sign me up!" type="submit"> 
</form:form>
</div>
</body>
</html>